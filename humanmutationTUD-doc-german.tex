...
bereits veröffentlichten Artikels und von~\citejournals{Cronin2017} eines sich
noch im Druck befindlichen Artikels
verdeutlicht. Für den Literaturtyp \verb|unpublished| wird ein
zusätzliches Feld \verb|doi={...}| zur Angabe der DOI (\textbf{D}igital
\textbf{O}bject \textbf{I}dentifier) bereitgestellt.

%TODO: Ausgabe der doi in der Quelle: "`DOI: ...."'
%TODO: url mit der DOI verlinken  url = {https://doi.org/10.1093/qjmed/hcx091},
%TODO: optionales Feld 'journal' bereitstellen
