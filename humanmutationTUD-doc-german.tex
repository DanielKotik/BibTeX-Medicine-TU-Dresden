...
\usepackage[%
  ...
  ,colorlinks         % Links erhalten Farben statt Kaesten; im Druck werden
...
\subsection{Zitieren von Artikeln}
...
Hier zitieren wir \citeweb{humanmutationSchneider} und
...
kann optional ein Datum .... übergeben werden. Ein Wert für das Feld
\verb|lastchecked={...}| ist hingegen zwingend erforderlich.
...
%TODO: Punkt vor 'short URL' entfernen
...
Tool (Zotero, Jabref, Endnote, Google Scholar etc.) mit dem Referenzen gesammelt und später in \hologo{BibTeX}-Einträge
